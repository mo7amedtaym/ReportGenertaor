...
fun CustomTimeInputField1(
    ...
    errorColor: Color= Color(0xffF04C8E)
) {
    ...
    OutlinedTextField(
        ...
        onValueChange = { newValue ->
            ...
            val formatted = buildString {
                when (digits.length) {
                    ...
                    1 -> append(if (digits[0] > '2') "0$digits" else digits)
                    2 -> {
                        append(digits)
                        if (digits.toInt() < 24) append(":")
                    }
                    3 -> {
            ...
            val newCursorPos = when {
                ...
                formatted.length == 3 && newValue.text.length == 2 -> 3
        ...
        colors = TextFieldDefaults.outlinedTextFieldColors(
            focusedBorderColor = if (isValid || value.isEmpty()) mainColor else errorColor,
            unfocusedBorderColor = if (isValid || value.isEmpty()) mainColor else errorColor,
        ...
        modifier = Modifier
            ...
            .onFocusChanged { focusState ->
                ...
                if (!focusState.isFocused && isValid) {
...
fun CustomTimeInputField2(
    ...
    Column(modifier = modifier.padding(4.dp)) {
        OutlinedTextField(
            ...
            shape = RoundedCornerShape(12.dp),
            singleLine = true,
            isError = !isValid && value.isNotEmpty() && !isFocused,
            colors = TextFieldDefaults.outlinedTextFieldColors(
